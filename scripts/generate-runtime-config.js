...
const config = {
  ...
  SITE_GITHUB_LINK: process.env.SITE_GITHUB_LINK || env.SITE_GITHUB_LINK || '',
  MASTODON_VERIFIED_LINK: process.env.MASTODON_VERIFIED_LINK || env.MASTODON_VERIFIED_LINK || '',
...
const configJs = `window.__APP_CONFIG__ = {
  ...
  githubLink: '${escapeJs(config.SITE_GITHUB_LINK)}',
  mastodonVerifiedLink: '${escapeJs(config.MASTODON_VERIFIED_LINK)}',
